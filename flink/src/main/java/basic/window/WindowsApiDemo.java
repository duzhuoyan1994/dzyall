...
//        dataSourceKeyby.window(ProcessingTimeSessionWindows.withDynamicGap()) //会话窗口，动态间隔，需要传入一个提取器
        ...
        // 2 指定窗口函数，窗口内数据的计算逻辑
        WindowedStream<String, String, TimeWindow> dataWindow = dataSourceKeyby.window(TumblingProcessingTimeWindows.of(Time.seconds(10)));
...
//        dataWindow.apply();
        ...
        //除了上面的api，在窗口函数里面还有 触发器trigger，移除器evictor
